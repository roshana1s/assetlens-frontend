...
const ReportDashboard = () => {
    ...
    const fetchReports = async () => {
        ...
        try {
            const response = await fetch(
                `${API_BASE_URL}/reports?org_id=${user.org_id}&user_id=${user.user_id}&limit=50`
            );
    ...
    const generateReport = async () => {
        ...
        try {
            ...
            toast.success(
                "Asset Tracking Daily Report generated successfully!"
            );
    ...
    const downloadReport = async (reportId) => {
        try {
            const response = await fetch(
                `${API_BASE_URL}/reports/${reportId}?org_id=${user.org_id}`
            );
    ...
    const deleteReport = async () => {
        ...
        try {
            const response = await fetch(
                `${API_BASE_URL}/reports/${currentReport.report_id}?org_id=${user.org_id}&user_id=${user.user_id}`,
                {
                    method: "DELETE",
                }
            );
    ...
    return (
        <div className="report-dashboard">
            ...
            >
                ...
                <Modal.Body>
                    <p>
                        Are you sure you want to delete this Asset Tracking
                        Daily Report?
                    </p>
                    {currentReport && (
                    ...
                    <div className="mt-3">
                        <small className="text-muted">
                            This action cannot be undone. The report will be
                            permanently deleted.
                        </small>
                    </div>
                </Modal.Body>
